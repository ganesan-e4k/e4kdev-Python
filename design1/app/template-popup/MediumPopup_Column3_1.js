...
const BootstrapModalMediumcolumn3_1 = ({ showModalMediumcolumn3_1, handleCloseMediumcolumn3_1 }) => {
 ...
 const modalDialogclassName = isMaximized ? 'modal-dialog modal-fullscreen' : 'modal-dialog medium-popup';
  ...
  return (
    <>
    <div className={`modal fade ${showModalMediumcolumn3_1 ? 'in' : ''}`} style={{ display: showModalMediumcolumn3_1 ? 'block' : 'none' }}>
                            ...
                            <div className="breadcomb-list">
                              <div className="row">
                                ...
                                <div className='popup-top-rightdiv'>
                                    <button type="button" className="close" onClick={handleCloseMediumcolumn3_1}>
                                      &times;
                                    </button>
...
export default BootstrapModalMediumcolumn3_1;