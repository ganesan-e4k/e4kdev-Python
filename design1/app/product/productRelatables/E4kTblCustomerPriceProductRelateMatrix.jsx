...
const E4kTblCustomerPriceProductRelateMatrix = ({ showModalMediumCustomerPriceProductMatrix, handleCloseMediumCustomerPriceProductMatrix }) => {
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                         ...
                                                         <div className='popup-topbar-title'>
                                                            1SCGUA01 - Customer Price - {selectProduct}
                                                        </div>
                                ...
                                <div className="container-fluid remove-padding">
                                    <div className="row">
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid-flex">
                                            <div className="customer-newbold"> 1SCGUA01 - Customer Price - {selectProduct !=='' ? selectProduct:'' } ({SelectProductDropDownChange !=='' ? (SelectProductDropDownChange):''}) </div>
...
export default E4kTblCustomerPriceProductRelateMatrix;
...
//     const handleChangePivotModeCustomerPriceProduct = (e) => {
//         console.log('Pivot mode changed: =>',e.detail.value)
//         setPivotModeCustomerPriceProduct(e.detail.value);
...
//         const table = document.getElementById('E4kTblProductPropertiescustomerPriceProductRelatematrixTable') 
//         const state = table.getState();
...
// 	const columns1 = [
// 		{ label: 'ProductID', dataField: 'productid', columnGroup: 'name', allowEdit: false },
// 		{
// 			label: 'Description', dataField: 'description', columnGroup: 'name' 
// 		},
...
//         setSelectProductDropDownChange(clickdata['productid'])
...
//                                                         <div className='popup-top-rightdiv'>
//                                                             <span className="innerpopup-top-rightdiv">Switch To Edit Mode:</span>
//                                                             <SwitchButton rightToLeft onChange={(e) => handleChangePivotModeCustomerPriceProduct(e)}></SwitchButton>
//                                                             <button type="button" className="btn-link" onClick={toggleMaximizeCustomerPriceProduct}>
//                                                                 {isMaximizedCustomerPriceProduct ? <i className='fa fa-compress'></i> : <i className='fa fa-expand'></i>}
//                                                             </button>
//                                                             <button type="button" className="close" onClick={() => handleCloseCustomerPriceProduct()}>
...
//                                     <div className="row">
//                                         <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid-flex">
//                                             <div className="customer-newbold"> 1SCGUA01 - Customer Price - {selectProduct} </div>
...
//                                     <div className='form-group master-option'>                                
//                                         {/* <DropDownList
//                                             ref={inputRefProductPriceTypeCustomerPriceCustomerListProduct}
//                                             id="TblProductProductPriceTypeDropdowncustomerPriceCustomerlistProduct"
//                                            // selectedIndexes={[0]}
//                                             virtualized ={true}
//                                             itemHeight={15}
//                                             filterable
//                                             placeholder="Select Product"
//                                             dataSource={Productlist.length > 0 ? Productlist.map(pro => pro.description) : []}
//                                             className='px-8'
//                                             onChange={(e) => handleDropDownonChangeCustomerlist(e)}
//                                             value = {SelectProductDropDownChange} 
//                                         /> */}
//                                         {pivotModeCustomerPriceProduct ? (
//                                             <span>
//                                                 <button className="btn alter-button" onClick={() => handleCopyStandardPriceProductApifunction()}>Copy Standard Price</button>
//                                             </span>) : (null)
//                                         }
...
//                                         {pivotModeCustomerPriceProduct ? (
//                                             <span>
//                                                 <button className="btn alter-button" onClick={() => handleCopyFirstCustomerPriceProduct()} >Copy Frist</button>
//                                             </span>) : (null)
//                                         }
//                                         </div>
//                                     </div>
...
//                                                 <PivotTable
//                                                     ref={pivotTableCustomerPriceProductRef}
//                                                     id="E4kTblProductPropertiespivotcustomerPriceProductRelatematrixTable"
//                                                     dataSource={dataSourceCustomerPriceProduct}
//                                                     freezeHeader  
//                                                     keyboardNavigation
//                                                     onColumnRender={onColumnRenderCustomerPriceProduct}
...
//                                                 <Table
//                                                     ref={tableCustomerPriceProductRef}
//                                                     id="E4kTblProductPropertiescustomerPriceProductRelatematrixTable"
//                                                     dataSource={dataSourceCustomerPriceProduct}
//                                                     freezeHeader
//                                                     keyboardNavigation
//                                                     columns={dataGridCustomerPriceProductcol}
